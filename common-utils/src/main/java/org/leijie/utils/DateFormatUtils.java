...
// 取值范围：就是临界点包不包含等于
    ...
    public static SimpleDateFormat sdfDateTime = new SimpleDateFormat(DateFormatUtils.DATE_FORMAT_DATETIME);
    public static SimpleDateFormat sdfDateOnly = new SimpleDateFormat(DateFormatUtils.DATE_FORMAT_DATEONLY);
    ...
    public static java.sql.Timestamp toSqlTimestamp(String sDate) {
        ...
        if (sDate.length() != DateFormatUtils.DATE_FORMAT_DATEONLY.length()
                && sDate.length() != DateFormatUtils.DATE_FORMAT_DATETIME.length()) {
            return null;
        }
        return toSqlTimestamp(sDate,
                sDate.length() == DateFormatUtils.DATE_FORMAT_DATEONLY.length()
                        ? DateFormatUtils.DATE_FORMAT_DATEONLY
                        : DateFormatUtils.DATE_FORMAT_DATETIME);
    ...
    public static java.sql.Timestamp toSqlTimestamp(String sDate, String sFmt) {
        ...
        if (sFmt.equals(DateFormatUtils.DATE_FORMAT_DATETIME)) {
            temp = sDate.replace('/', '-');
            temp = temp + ".000000000";
        } else if (sFmt.equals(DateFormatUtils.DATE_FORMAT_DATEONLY)) {
            temp = sDate.replace('/', '-');
    ...
    public static String getSysDateTimeString() {
        return toString(new java.util.Date(System.currentTimeMillis()), DateFormatUtils.sdfDateTime);
    }
    ...
    public static String toSqlTimestampString2(java.sql.Timestamp dt) {
        ...
        String temp = toSqlTimestampString(dt, DateFormatUtils.DATE_FORMAT_DATETIME);
    ...
    public static String toSqlTimestampString(java.sql.Timestamp dt, String sFmt) {
        ...
        temp = dt.toString();
        if (sFmt.equals(DateFormatUtils.DATE_FORMAT_DATETIME) || // "YYYY/MM/DD
// HH24:MI:SS"
                sFmt.equals(DateFormatUtils.DATE_FORMAT_DATEONLY)) { // YYYY/MM/DD
            temp = temp.substring(0, sFmt.length());
            out = temp.replace('/', '-');
// }else if( sFmt.equals (DateFormatUtils.DATE_FORMAT_SESSION ) ){
// //Session
// out =
...
// out += temp.substring(12,14) + temp.substring(15,17);
    ...
    public static String timestampToStringYMD(java.sql.Timestamp timestamp) {
        SimpleDateFormat sdf = new SimpleDateFormat(DateFormatUtils.DATE_FORMAT_DATEONLY);
    ...
    public static boolean isOverIntervalLimit(String startDateStr, String endDateStr, int interval) {
        ...
        Date endDate = null;
        try {
            startDate = DateFormatUtils.parseDate(startDateStr, DateFormatUtils.DATE_FORMAT_DATEONLY);
            endDate = DateFormatUtils.parseDate(endDateStr, DateFormatUtils.DATE_FORMAT_DATEONLY);
        } catch (ParseException e) {
            logger.error(e);
            return false;
        }
    ...
    public static Date getMaxTime(Date dt) {
        ...
        dt1 = ca.getTime();
        dt1 = DateFormatUtils.getMinTime(dt1);
        ca.setTime(dt1);
    ...
    public static Date getMinTime(Date dt) {
        Date dt1 = null;
        dt1 = DateFormatUtils.getDateByStr(DateFormatUtils.formatDate(dt, "yyyy-MM-dd"));
        return dt1;
    }
...
// subYear==0,说明是同一年
    ...
    public static List<String> getLastDays(int countDay) {
        ...
        for (int i = 0; i < countDay; i++) {
            listDate.add(DateFormatUtils.getReqDateyyyyMMdd(DateFormatUtils.getDate(-i)));
        }
        return listDate;
    }
